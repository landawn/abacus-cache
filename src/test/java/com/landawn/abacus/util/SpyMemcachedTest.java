...
public class SpyMemcachedTest extends TestCase {
    ...
    public void testSetGetOneObject() {
        ...
        N.println("Take " + (System.currentTimeMillis() - startTime) + " milliseconds to set " + loops + " object from memcached. ");
        ...
        N.println("Take " + (System.currentTimeMillis() - startTime) + " milliseconds to get " + loops + " object from memcached. ");
    ...
    public void testSetGetManyObjects() {
        ...
        N.println("Take " + (System.currentTimeMillis() - startTime) + " milliseconds to set " + loops + " objects from memcached. ");
        ...
        N.println("Take " + (System.currentTimeMillis() - startTime) + " milliseconds to get " + loops + " objects from memcached. ");
    ...
    public void testSetGetBigArray() {
        ...
        N.println("Take " + (System.currentTimeMillis() - startTime) + " milliseconds to set " + loops + " Object[" + objectNum + "] to memcached. ");
        ...
        N.println("Take " + (System.currentTimeMillis() - startTime) + " milliseconds to get " + loops + " Object[" + objectNum + "] from memcached. ");
    ...
    private static String getEmail(String uuid) {
