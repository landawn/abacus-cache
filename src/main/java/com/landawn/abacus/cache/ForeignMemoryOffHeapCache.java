...
public class ForeignMemoryOffHeapCache<K, V> extends AbstractOffHeapCache<K, V> {
     ...
     * obtain an instance through the builder obtained from {@link #builder()}. (The {@link CacheFactory}
     * {@code createOffHeapCache} methods construct the {@code sun.misc.Unsafe}-based {@link OffHeapCache};
     * this Foreign-Memory variant is builder-only.)
     *
     * <p><b>Memory Management:</b>
    ...
    /**
     * Creates a new builder for constructing {@link ForeignMemoryOffHeapCache} instances.
     ...
     * ForeignMemoryOffHeapCache<String, byte[]> advancedCache = ForeignMemoryOffHeapCache.<String, byte[]>builder()
     ...
     * @param <K> the type of keys used to identify cache entries
     * @param <V> the type of values stored in the cache
     * @return a new {@link Builder} instance initialized with default configuration values
     * @see Builder
     * @see Builder#build()
     */
    ...
    /**
     * Fluent builder for creating {@link ForeignMemoryOffHeapCache} instances with custom configuration.
     ...
     * ForeignMemoryOffHeapCache<String, User> customCache = ForeignMemoryOffHeapCache.<String, User>builder()
     *     .capacityInMB(50)
     ...
     * @param <K> the type of keys used to identify cache entries
     * @param <V> the type of values stored in the cache
     * @see ForeignMemoryOffHeapCache#builder()
     */
    @Data
    ...
    public static class Builder<K, V> {
         ...
         * Prefer the factory method {@link ForeignMemoryOffHeapCache#builder()} over invoking this constructor directly.
         *
         * <p><b>Usage Examples:</b>
         * <pre>{@code
