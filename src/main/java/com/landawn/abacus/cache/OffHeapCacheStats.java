...
public record OffHeapCacheStats(int capacity, int size, long sizeOnDisk, long putCount, long putCountToDisk, long getCount, long hitCount, long hitCountByDisk,
    ...
    /**
     * Returns a map of occupied slots. The key is the size of the slot, and the value is a map of segment index and the number of occupied slots in the segment.
     *
     * @return
     */
