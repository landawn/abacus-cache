...
public class OffHeapCache<K, V> extends AbstractOffHeapCache<K, V> {
    ...
    public static class Builder<K, V> {
         ...
         * This memory remains allocated until {@link OffHeapCache#close()} is called on the returned cache instance.
         ...
         * }</pre>
         *
         * @return a new {@link OffHeapCache} instance configured with the builder's settings
