...
[![Javadocs](https://img.shields.io/badge/javadoc-1.26.5-brightgreen.svg)](https://www.javadoc.io/doc/com.landawn/abacus-cache/1.26.5/index.html)
...
```gradle
// JDK 25 or above:
compile 'com.landawn:abacus-cache:1.26.5'
```
