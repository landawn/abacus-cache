...
[![Javadocs](https://img.shields.io/badge/javadoc-1.2.5-brightgreen.svg)](https://www.javadoc.io/doc/com.landawn/abacus-cache/1.2.5/index.html)
...
```gradle
// JDK 1.8 or above:
compile 'com.landawn:abacus-cache:1.2.5'
```
