...
[![Javadocs](https://img.shields.io/badge/javadoc-2.6.4-brightgreen.svg)](https://www.javadoc.io/doc/com.landawn/abacus-cache/2.6.4/index.html)
...
```gradle
// JDK 25 or above:
compile 'com.landawn:abacus-cache:2.6.4'
```
